...
export default function Consent({ onDone }: { onDone: () => void }) {
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-md flex-col px-5 pb-8 pt-16">
      <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-softer">
        <svg className="h-8 w-8 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.7}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
        </svg>
      </div>

      <h1 className="mt-6 text-center font-head text-2xl font-bold">
        Согласие на обработку персональных данных
      </h1>
      <p className="mt-4 text-center text-sm leading-relaxed text-accent-dark">
